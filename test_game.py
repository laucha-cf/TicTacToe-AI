...
class TestTicTacToe(unittest.TestCase):
    ...
    def test_available_moves_3(self):
    ...
    def test_count_empty_squares_1(self):
        """Test empty board
        """
        game = TicTacToe()
        assert(game.count_empty_squares() == 9)

    def test_count_empty_squares_2(self):
    ...
    def test_count_empty_squares_3(self):
        """Test full board
        """
        game = TicTacToe()
        new_board = np.array(['X','O','X','O','O','O','X','O','X'])
    ...
    #TEST empty_squares
    def test_empty_squares_1(self):
        """Test empty board
        """
        game = TicTacToe()
        assert(game.empty_squares() == True)

    def test_empty_squares_2(self):
        """Test board with some squares filled
        """
        game = TicTacToe()
        new_board = np.array([' ',' ','X',' ',' ','O',' ',' ','X'])
